...
//    document.getElementById('reverse_prompt_2').value = 'no elongated waists, no blurred details, no unnatural body stretching,no unrealistic body features,no overly exaggerated body parts,no incorrect body proportions' //'unrealistic features,overly exaggerated body parts,incorrect proportions';
    ...
    // 设置输入字段的默认值
    document.getElementById('prompt').value = 'nude,person,woman,authenticity,big and natural asses,big and natural boobs';
    document.getElementById('reverse_prompt').value = 'deformed limbs,disconnected limbs,contorted position,elongated waists, overly exaggerated body parts,incorrect proportions, multiple belly buttons,multiple breasts';
