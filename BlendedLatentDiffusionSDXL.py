...
class BlendedLatentDiffusionSDXL(StableDiffusionXLPipeline):
    ...
    def edit_image(
        ...
        # Set up for classifier-free guidance
        ...
        # Apply denoising_end
        if denoising_end is not None and 0 < denoising_end < 1:
...
if __name__ == "__main__":
    ...
    # 加载模型并设置设备
    bld = BlendedLatentDiffusionSDXL.from_pretrained(args.model_path, torch_dtype=torch.float16, variant="fp16",
