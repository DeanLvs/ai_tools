...
if __name__ == "__main__":
    """Example usage:
    python3 lama_inpaint.py \
        --input_img /mnt/essd/ai_tools/Inpaint-Anything/example/remove-anything/dog.jpg \
        --input_mask_glob "/mnt/essd/ai_tools/Inpaint-Anything/example/remove-anything/dog/with_mask.png" \
        --output_dir results \
