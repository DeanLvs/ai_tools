...
import torch
import gc
from diffusers import StableDiffusionXLInpaintPipeline, UNet2DConditionModel, AutoencoderKL, EulerDiscreteScheduler, DPMSolverMultistepScheduler
...
class CustomInpaintPipeline:
    ...
    def __init__(self, model_path="stable-diffusion-xl-1.0-inpainting-0.1"):
        if not hasattr(self, "_initialized"):
            ...
            # ptgs.safetensors 0.1
            self.load_lora_weights(lora_path="/mnt/sessd/civitai-downloader/lora/Nipples XL - All in One.safetensors", lora_scale=0.3, adapter_name="nudifyitw")
            self.load_lora_weights(lora_path="/mnt/sessd/civitai-downloader/lora/biggunsxl_v11.safetensors", lora_scale=0.3, adapter_name="bigsxl")
            self.load_lora_weights(lora_path="/mnt/sessd/civitai-downloader/lora/NudeXL.safetensors",
                                   lora_scale=0.3, adapter_name="bigsxlxx")
