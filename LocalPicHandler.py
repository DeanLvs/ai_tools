...
# 加载图像
image_path = "/Users/dean/Desktop/cb45ac85254a115f83761faff0c4e150.png"  # 替换为您的本地图片路径
...
# 设置本地模型路径
model_path = "/Users/dean/PycharmProjects/ai_tools/pythonProject/stable-diffusion-2-inpainting"  # 替换为你的模型文件夹路径
...
unet_path = "/mnt/sessd/civitai-downloader/pornmasterPro_v8-inpainting.safetensors"  # 替换为您下载的 Checkpoint Merge 模型路径
...
hyper_vae_path = "/Users/dean/Downloads/realisticVisionV60B1_v51HyperInpaintVAE.safetensors"  # 替换为你的权重文件路径
...
# 生成图像
prompt = "remove the clothes of the person, revealing the  human skin, large breasts"
reverse_prompt = "retain clothes, modesty"
# num_inference_steps = 60  # 增加生成步骤
guidance_scale = 8  # 调整指导尺度
with torch.no_grad():
...
# 保存生成的图像
result.save("/Users/dean/Desktop/output25.png")
result.show()