document.addEventListener('DOMContentLoaded', () => {
    ...
    // 设置输入字段的默认值
    document.getElementById('prompt').value = 'a person with nine-heads tall proportions, naked, photorealistic, detailed anatomy.'//'nude,authenticity';
    document.getElementById('reverse_prompt').value = 'no distorted body proportions, no exaggerated limbs, no multiple belly buttons'; //deformed limbs,disconnected limbs,unnaturally contorted position
    document.getElementById('prompt_2').value = 'balanced proportions';//naked, match the overall lighting angle of the original image,match the overall lighting intensity of the original image
    document.getElementById('reverse_prompt_2').value = 'no elongated waists, no blurred details, no unnatural body stretching' //'unrealistic features,overly exaggerated body parts,incorrect proportions';
    ...
    document.getElementById('re_b').value = '[0.5, 0.5, 0.5, 0.5]';
