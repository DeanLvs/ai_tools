...
//    document.getElementById('reverse_prompt_2').value = 'no elongated waists, no blurred details, no unnatural body stretching,no unrealistic body features,no overly exaggerated body parts,no incorrect body proportions' //'unrealistic features,overly exaggerated body parts,incorrect proportions';
    ...
    // 设置输入字段的默认值
    document.getElementById('prompt').value = 'nude,person,woman,authenticity';
    document.getElementById('reverse_prompt').value = 'no deformed limbs,no disconnected limbs,unnaturally contorted position';
    ...
    document.getElementById('reverse_prompt_2').value = 'no elongated waists, unrealistic features,overly exaggerated body parts,incorrect proportions, no multiple belly buttons';

    document.getElementById('num_inference_steps').value = '40';
    document.getElementById('guidance_scale').value = '6.5';
    document.getElementById('seed').value = '128';
    document.getElementById('re_p').value = "['key_points','depth','canny']";
    document.getElementById('re_b').value = '[1.0, 0.5, 0.5, 0.8]';
    document.getElementById('ha_p').value = '0';
    document.getElementById('ga_b').value = '0.09';
    document.getElementById('re_mask').value = 'F';
    document.getElementById('strength').value = '0.844';
