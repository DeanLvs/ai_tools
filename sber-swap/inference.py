...
class InputArgs:
    def __init__(self,  source_paths=[],target_faces_paths=[],
                 ...
                 G_path='weights/G_unet_2blocks.pth', backbone='unet', num_blocks=2, batch_size=40,
...
def api_run(source_paths, target_faces_paths, target_image, target_video):
    if target_image is not None and target_image != '':
        ...
        target_image = ''
        image_to_image = False
    args = InputArgs(source_paths=source_paths, target_faces_paths=target_faces_paths,target_image=target_image, target_video=target_video, image_to_image=image_to_image)
    main(args)
