...
class CustomInpaintPipeline:
    ...
    def _initialize_pipe(self):
        ...
        print(f'init ----------------------------- use ControlNet Pipeline '
              f'{len(to_controlnet)} {type(to_text_encoder)} {type(to_text_encoder_2)} {type(to_tokenizer)} {type(to_tokenizer_2)}')
    ...
    def genIt(self, g_c_param: GenContextParam):
        gen_it_prompt = ''
        try:
            print(f"gen use prompt: {g_c_param}")
                    ...
                    for cont in self.controlnet_list:
                        if 'key_points' == cont:
                            ...
                            if g_c_param.control_img_list[1]:
                                ...
                                print(f'use def none depth pic pic---------')
